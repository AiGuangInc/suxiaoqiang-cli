...
const zh = {
  ...
  'deploy.success': '上线完成',
  'deploy.failed': '上线失败',
  'deploy.serverFailed': '服务端已返回发布失败',
  'deploy.failedStep': '步骤 {step}（{status}）: {detail}',
  'deploy.unknownError': '未返回具体错误',
...
const en: Record<MessageKey, string> = {
  ...
  'deploy.serverFailed': 'The server reported that the release failed',
  'deploy.failedStep': 'Step {step} ({status}): {detail}',
  'deploy.unknownError': 'No specific error was returned',
